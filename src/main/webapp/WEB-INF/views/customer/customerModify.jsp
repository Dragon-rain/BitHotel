...
th, td {
	...
	<form action="/customerModify" method="post">
		...
		<table style="margin-left: 785px;">

			<tr>
				<td id="title" width="150px">ID</td>
				<td><input
					style="text-align: center; border: none; width: 180px; letter-spacing: 2px"
					type="text" maxlength="15" name="customerID"
					value="${customer.customerID}" readonly></td>

			</tr>
			<tr>
				<td id="pw" style="font-weight: bold;">비밀번호</td>
				<td><input style="text-align: center; border: none;"
					type="password" maxlength="15" placeholder="6~15자리로 입력하세요"
					name="customerPW"></td>
			<tr>
				<td id="name" style="font-weight: bold;">성&nbsp&nbsp함</td>
				<td>${customer.customerName }</td>
			</tr>
			<tr>
				<td id="ssn" style="font-weight: bold;">주민등록번호</td>
				<td style="letter-spacing: 1px;">${customer.SSNumber }</td>

			</tr>
			<tr>
				<td id="phn" style="font-weight: bold;">핸드폰번호</td>
				<td><input
					style="border: none; letter-spacing: 2px; text-align: center;"
					type="text" maxlength="15" placeholder="010-0000-0000"
					name="customerPhoneNumber"></td>
			</tr>
		...
		<div align="center">
			<input type="submit" value="수정완료" onclick="alert('수정완료')" />
			&nbsp&nbsp <input type="button" value="탈퇴하기"
